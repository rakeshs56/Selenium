...
public class test2 {
	...
	public void test2() throws InterruptedException {
		...
		ctn.click();
		Thread.sleep(2000);
		WebElement tinyMites =driver.findElement((By.id("tinyMites")));
		tinyMites.sendKeys("1");
		WebElement ctnr =driver.findElement((By.id("btnContinueRating")));
		WebElement head =driver.findElement((By.id("contentHeader")));
		head.click();
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		Actions act = new Actions(driver);
		act.doubleClick(ctnr).perform();
		WebElement con =driver.findElement((By.xpath("//*[@id=\"contentDancePart2\"]/div/span/h2")));
		String str="Premium Quote";
		if(!str.equals(con.getText())) {
			ctnr.click();
			Thread.sleep(2000);
			}
		...
		if(con.getText()=="Premium Quote") {
		wait.until(ExpectedConditions.elementToBeClickable(con));}
		
		WebElement conrd =driver.findElement((By.id("btnContinueRatingDetails")));
		conrd.click();
		WebElement c1 =driver.findElement((By.id("checkEquipmentLabel")));
		c1.click();
		WebElement c2 =driver.findElement((By.id("checkDandOLabel")));
		c2.click();
		WebElement c3 =driver.findElement((By.id("checkEmpDishLabel")));
		c3.click();
		WebElement btnc =driver.findElement((By.id("btnNavNext")));
		btnc.click();
		//driver.quit();
